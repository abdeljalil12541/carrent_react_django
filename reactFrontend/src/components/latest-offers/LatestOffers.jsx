...
const LatestOffers = ({ selectedCurrency }) => {
    ...
    useEffect(() => {
        const fetchLatestOffers = async () => {
            try {
                setLoader(true);
                const response = await axios.get('https://carrent-polished-shadow-812.fly.dev/api/latest-offers/');
        ...
        <div className="container mx-auto py-4 px-2 sm:px-8 md:px-10 lg:px-14">
            ...
            {latestOffers && latestOffers.map((offer, index) => {
                ...
                const carDetails = {
                    ...
                    image: `https://carrent-polished-shadow-812.fly.dev${offer.car.image}`,
                    brand: `https://carrent-polished-shadow-812.fly.dev${offer.car.brand}`,
                ...
                return (
                    <div key={index} className="relative overflow-hidden rounded-lg mb-9">
                        <div className="relative h-[420px] sm:h-[400px] w-full">
                            ...
                            <img
                                src={`https://carrent-polished-shadow-812.fly.dev${offer.image}`}
                                alt={offer.title}
