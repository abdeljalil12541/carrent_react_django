              ...
              {currentCars.map((car, index) => (
                    <div key={index} className="border hover:border-red-600 hover:shadow-lg duration-300 border-sm pl-4 py-4 border-gray-200 mt-4 w-full grid grid-cols-7">
                        <div className="col-span-7 md:col-span-2 pl-2">
                          <Link to={`/location-de-voitures/${car.slug}`} state={{car, finalDateTime, finalDestination}}><img src={car.image} width={120} alt={car.name} /></Link>
                        ...
                        <div className="col-span-7 md:col-span-2 flex md:ml-[1px] items-center md:-ml-6">
