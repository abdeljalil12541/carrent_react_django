    ...
    return (
        ...
        <div className="home relative">
            ...
            <div className="col-span-3 lg:col-span-2">
                ...
                <div className="col-span-3 mt-9 lg:mt-0 lg:col-span-1 lg:flex lg:flex-col sm:flex-row sm:grid grid-cols-2 items-center">
                    {/* Weather Info Section */}
                    <div className="col-span-1 weather-info flex mt-3 flex-col lg:flex-col">
                        <h2 className="text-4xl font-light text-center text-white">CASABLANCA OFFICE</h2>
                    ...
                    <div className="col-span-1 flex lg:flex-col items-center justify-center lg:mt-8">
                        <div className="flex flex-col">
                            <a href="" className="flex justify-center mt-8 font-medium hover:text-white" style={{color: "#e2e8f0"}}>
