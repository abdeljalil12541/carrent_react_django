...
useEffect(() => {
  ...
  const price = formatPrice(convertPrice(minPrice, 'MAD dh', currencyCode), currencyCode);
  const displayMinPrice = price || 0
                ...
                <div className={`col-span-3 hideItemsRes ${isSameDestination? '': 'bookingDesHomeRes'} hidden sm:block lg:mt-0 bookingHomeRes lg:ml-9 lg:col-span-1 lg:flex lg:flex-col sm:flex-row sm:grid grid-cols-2 items-center`}>
                    ...
                    <div className={`col-span-1 hidden md:block weather-info flex ${isSameDestination? 'mt-4': 'mt-0'} sm:mt-24 marginForCountUpSpaceRes lg:-mr-14 flex-col lg:flex-col`}>
                        ...
                        <div className={`flex items-center ${isSameDestination? 'mt-4':'mt-2'} font-light mb-4 sm:mb-0 sm:font-normal  sm:mt-6 justify-center`}>
                            ...
                            <span className="text-8xl text-gray-100"><House strokeWidth={2} size={50} /></span>
                        </div>
                    </div>
                    ...
                    <div className="col-span-1 hidden md:block flex lg:flex-col items-center justify-center lg:mt-0  marginForCountUpSpaceRes lg:-mr-14">
                        <div className="flex flex-col">
                            <a href="" className={`ml-2 sm:ml-0 text-sm text-center flex sm:text-[16px] justify-center sm:mt-8 font-medium text-gray-200 hover:text-white`}>
                                <svg className="pr-2" viewBox="0 0 24 24" style={{marginTop: '-1px'}} height={20} fill="#e2e8f0" xmlns="http://www.w3.org/2000/svg">
                                ...
                                {carsCount? carsCount : 0} Voitures from {displayMinPrice}/jour
                            </a>

                            <div className="w-full flex justify-center mt-9">
                                <button onClick={goToCarsPageBtn} className="py-3 px-4 font-medium hover:bg-red-500 duration-300 rounded-md bg-red-700 text-white">
                                    Explore
