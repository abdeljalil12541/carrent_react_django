...
const HomePageMoroccoBaner = () => {
    ...
    const goToFaqBtn = () => {
        setLoader(true)
        setTimeout(() => {
            navigate('/questions-frequemment-posees');
        }, 300);
    }
    return(
        <div className="w-full">
            <div className='w-full relative'>
                ...
                <div className='aboutUsContent w-full flex justify-center items-center'>
                    <div>
                        <p className='text-sm sm:text-xl md:text-3xl lg:text-5xl font-light text-center text-white'>Disponible 24/7 <br /> Notre ligne téléphonique est disponible 24/7 Us</p>
                        <div className='w-full flex justify-center mt-5 md:mt-10'>
                            <button onClick={goToFaqBtn} className='py-3 hover:bg-red-500 mt-8 duration-150 text-xs md:text-base px-3 sm:px-6 rounded-3xl bg-red-600 text-white'>En savoir plus sur RN Car - FAQ</button>
                        </div>
                    </div>
                </div>
